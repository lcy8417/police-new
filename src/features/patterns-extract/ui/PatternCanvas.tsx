            ...
            {showOverlayChrome && region && (
              <>
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  {/* 실제 아웃솔(밑창) 실루엣: 위(toe)는 넓고 둥글게, 가운데(허리/arch)는
                      안쪽(오른쪽=medial)으로 깊게 파여 잘록해지고, 아래(heel)는 좁고
                      둥글게 — 좌우 폭이 비대칭이라 scaleX(-1) 반전 시 왼쪽/오른쪽 신발이
                      뚜렷이 구분된다(뒤꿈치 중심이 발끝 중심보다 왼쪽으로 치우침). */}
                  <path
                    d="M50,2 C74,2 92,16 92,34 C96,50 98,58 96,66 C94,84 88,98 78,112 C68,128 58,138 56,156 C54,174 60,192 62,208 C64,228 58,248 54,262 C50,276 46,288 42,296 C38,300 32,300 28,298 C24,296 18,290 16,262 C14,248 10,228 12,208 C14,192 20,174 18,156 C16,138 12,128 10,112 C8,98 4,84 6,66 C8,58 10,50 14,34 C18,16 26,2 50,2 Z"
                    fill="#3B82F6"
                    fillOpacity={0.16}
                    stroke="#4A9EFF"
                    strokeOpacity={0.75}
